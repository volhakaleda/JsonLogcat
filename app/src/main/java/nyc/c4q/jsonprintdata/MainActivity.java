...
public class MainActivity extends AppCompatActivity {
    ...
    private  List<String> lisOfBulldogs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            JSONObject jsonMessageObject = newJsonObject.getJSONObject("message");

            JSONArray jsonArray = jsonMessageObject.getJSONArray("bulldog");

            lisOfBulldogs = new ArrayList<>();
